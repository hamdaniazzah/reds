...
location.hash.indexOf("#pulsa-jadi-uang")>-1&&window.location.replace("/p/convert-pulsa.html"),
location.hash.indexOf("#pay")>-1&&window.location.replace("/p/payment-method.html");
/* redS End */
